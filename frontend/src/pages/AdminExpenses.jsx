    ...
    <div>
      ...
      {sum.months.length > 0 && (
        <div className="card" style={{ padding: 0 }}>
          ...
          <p className="muted" style={{ padding: '6px 16px 12px' }}>Месяц взят из комментария («хайр май окл»); строка без месяца получает месяц строки выше. В статьях, где месяц почти не пишут, такие строки остаются «без месяца» — проставьте его в строке. Клик по ячейке — строки этого месяца ниже.</p>
        </div>
      )}
